<?php
	...
	while($billrow=mysqli_fetch_array($bills)){
		echo "<div class='container well order-container' ><div class='row'><div class='col-md-4 col-xs-4'> <button class='btn btn-info btn-block' type='button'><strong>Order ID ".$billrow['bid']."</strong></button></div></div>";
		...
		echo "<div class='row'><span  style='font-weight: bold; color:#31708f '><div class='col-md-6 col-xs-6 text-left '>Purchased on : ".$billrow['pdate']."</div><div class='col-md-6 col-xs-6 text-right'>Order total : <span style='font-weight: bold; font-size:20;'><i class='fa fa-rupee'></i>".$billrow['total']."</span></div></div></div>";
	}
